...
-   Explore the application and effectiveness of training/testing data for this COVID-19 dataset to create a polynomial regression model vs using K-Fold Cross Validaton to make predictions.
